...
/**
 * iso 3661-1 alpha 2
 * https://github.com/lingtalfi/iso/blob/master/countries-iso-3661-1-alpha2.php
 */
$countries = [
    'AF' => [
        'fra' => 'Afghanistan',
    ...
    'BO' => [
        'fra' => 'Bolivie, L\'état Plurinational De',
        'eng' => 'Bolivia',
    ],
    'BQ' => [
        'fra' => 'Bonaire, Saint-Eustache Et Saba',
        'eng' => 'Bonaire, Saint Eustatius and Saba',
    ],
    'BA' => [
    ...
    'CD' => [
        'fra' => 'Congo, La République Démocratique Du',
    ...
    'KR' => [
        'fra' => 'Corée, République De',
        'eng' => 'South Korea',
    ],
    'KP' => [
        'fra' => 'Corée, République Populaire Démocratique De',
        'eng' => 'North Korea',
    ],
    'CR' => [
        'fra' => 'Costa Rica',
    ...
    'HM' => [
        'fra' => 'Heard-Et-Îles Macdonald, Île',
    ...
    'LA' => [
        'fra' => 'Lao, République Démocratique Populaire',
        'eng' => 'Laos',
    ],
    'LS' => [
        'fra' => 'Lesotho',
    ...
    'MK' => [
        'fra' => 'Macédoine, L\'ex-République Yougoslave De',
        'eng' => 'Macedonia',
    ],
    'MG' => [
        'fra' => 'Madagascar',
    ...
    'FM' => [
        'fra' => 'Micronésie, États Fédérés De',
        'eng' => 'Micronesia',
    ],
    'MD' => [
        'fra' => 'Moldova, République De',
        'eng' => 'Moldova',
    ],
    'MC' => [
        'fra' => 'Monaco',
    ...
    'IO' => [
        'fra' => 'Océan Indien, Territoire Britannique De L\'',
    ...
    'PS' => [
        'fra' => 'Palestinien Occupé, Territoire',
        'eng' => 'Palestinian Territory',
    ],
    'PA' => [
        'fra' => 'Panama',
        'eng' => 'Panama',
    ...
    'MF' => [
        'fra' => 'Saint-Martin(Partie Française)',
        'eng' => 'Saint Martin',
    ],
    'SX' => [
    ...
    'VE' => [
        'fra' => 'Venezuela, République Bolivarienne Du',
        'eng' => 'Venezuela',
    ],
    'VN' => [
        'fra' => 'Viet Nam',
