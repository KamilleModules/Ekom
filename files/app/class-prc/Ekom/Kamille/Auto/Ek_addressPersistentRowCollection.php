...
class Ek_addressPersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_address.id as `ek_address.id`,
ek_address.type as `ek_address.type`,
ek_address.city as `ek_address.city`,
ek_address.postcode as `ek_address.postcode`,
ek_address.address as `ek_address.address`,
ek_address.active as `ek_address.active`,
ek_state.iso_code as `ek_state.iso_code`,
ek_country.iso_code as `ek_country.iso_code`
';
        $this->query = '
SELECT
%s
