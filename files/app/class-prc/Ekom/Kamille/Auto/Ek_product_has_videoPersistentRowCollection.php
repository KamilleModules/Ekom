...
class Ek_product_has_videoPersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_product_has_video.product_id as `ek_product_has_video.product_id`,
ek_product_has_video.video_id as `ek_product_has_video.video_id`,
ek_product.product_reference_id as `ek_product.product_reference_id`,
ek_video.uri as `ek_video.uri`
';
        $this->query = '
SELECT
%s
