...
class Ek_featurePersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        parent::__construct();
        $this->setTable("kamille.ek_feature");
        $this->fields = '
ek_feature.id as `ek_feature.id`,
...
SELECT
%s
FROM kamille.ek_feature
inner join kamille.ek_lang on kamille.ek_lang.id=ek_feature.lang_id
';
    }
