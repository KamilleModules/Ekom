...
class Ek_country_langPersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_country_lang.country_id as `ek_country_lang.country_id`,
ek_country_lang.lang_id as `ek_country_lang.lang_id`,
ek_country_lang.label as `ek_country_lang.label`,
