...
class Ek_tagPersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        parent::__construct();
        $this->setTable("kamille.ek_tag");
        $this->fields = '
ek_tag.id as `ek_tag.id`,
...
%s
FROM kamille.ek_tag
inner join kamille.ek_lang on kamille.ek_lang.id=ek_tag.lang_id
';
    }
