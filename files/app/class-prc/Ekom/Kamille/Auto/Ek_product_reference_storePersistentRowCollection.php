...
class Ek_product_reference_storePersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_product_reference_store.id as `ek_product_reference_store.id`,
ek_store.label as `ek_store.label`,
ek_product_reference_store.quantity as `ek_product_reference_store.quantity`,
