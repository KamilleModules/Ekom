...
class Ek_role_profile_has_role_badgePersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_role_profile_has_role_badge.role_profile_id as `ek_role_profile_has_role_badge.role_profile_id`,
ek_role_profile_has_role_badge.role_badge_id as `ek_role_profile_has_role_badge.role_badge_id`,
ek_role_profile.label as `ek_role_profile.label`,
ek_role_badge.label as `ek_role_badge.label`
';
        $this->query = '
SELECT
%s
