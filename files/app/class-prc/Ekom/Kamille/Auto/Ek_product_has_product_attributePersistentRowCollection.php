...
class Ek_product_has_product_attributePersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_product_has_product_attribute.product_id as `ek_product_has_product_attribute.product_id`,
ek_product_has_product_attribute.product_attribute_id as `ek_product_has_product_attribute.product_attribute_id`,
ek_product.product_reference_id as `ek_product.product_reference_id`,
ek_product_attribute.label as `ek_product_attribute.label`,
ek_product_attibute_value.label as `ek_product_attibute_value.label`
';
        $this->query = '
SELECT
%s
