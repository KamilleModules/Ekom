...
class Ek_userPersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_user.id as `ek_user.id`,
ek_user_group.label as `ek_user_group.label`,
ek_user.email as `ek_user.email`,
ek_user.pass as `ek_user.pass`,
ek_user.base_shop_id as `ek_user.base_shop_id`,
ek_user.date_creation as `ek_user.date_creation`,
ek_user.active as `ek_user.active`,
ek_address.type as `ek_address.type`,
ek_user.mobile as `ek_user.mobile`,
ek_user.phone as `ek_user.phone`,
ek_user.pro as `ek_user.pro`
';
        $this->query = '
SELECT
%s
