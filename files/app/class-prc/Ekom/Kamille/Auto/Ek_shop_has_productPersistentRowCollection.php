...
class Ek_shop_has_productPersistentRowCollection extends NullosQuickPdoPersistentRowCollection
{
    public function __construct()
    {
        ...
        $this->fields = '
ek_shop_has_product.shop_id as `ek_shop_has_product.shop_id`,
ek_shop_has_product.product_id as `ek_shop_has_product.product_id`,
ek_shop.label as `ek_shop.label`,
ek_product.product_reference_id as `ek_product.product_reference_id`,
ek_shop_has_product.active as `ek_shop_has_product.active`
';
        $this->query = '
SELECT
%s
