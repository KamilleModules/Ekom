            ...
            <div class="rightbar">
                ...
                <?php if (SessionUser::isConnected()): ?>
                    <div class="my-account-link">
                        <a href="<?php echo E::link("Ekom_customerDashboard"); ?>" class="connexion">MON COMPTE</a>
                            ...
                            <?php if ('management' !== $cat['name']): ?>
                                ...
                                <ul>
                                    ...
                                    foreach ($cat['children'] as $subcat): ?>
                                        <li>
                                            <a href="<?php echo htmlspecialchars($subcat['uri']); ?>"><?php echo ucfirst(mb_strtolower($subcat['label']));
