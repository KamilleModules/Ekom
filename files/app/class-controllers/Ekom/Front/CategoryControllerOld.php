...
class CategoryControllerOld extends EkomFrontController
{
    ...
    public function render()
    {
        ...
        if (in_array($slug, $specialCats)) {

            $uriImg = E::getImgBaseUri();
            $cats = EkomApi::inst()->categoryLayer()->getSubCategoriesByName($slug, 0);
            $tCats = [];
            foreach ($cats as $cat) {
            ...
            return $this->renderByViewId("Ekom/category-$slug", LawsConfig::create()->replace([
                "widgets" => [
