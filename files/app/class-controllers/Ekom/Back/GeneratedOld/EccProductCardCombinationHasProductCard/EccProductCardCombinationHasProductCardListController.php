...
select $repr from `ecc_product_card_combination` where id=:product_card_combination_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_EccProductCardCombinationHasProductCard_List") . "?form&product_card_combination_id=$product_card_combination_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_EccProductCardCombination_List") . "?id=$product_card_combination_id",
                ],
            ],
            "context" => [
            	"product_card_combination_id" => $product_card_combination_id,
