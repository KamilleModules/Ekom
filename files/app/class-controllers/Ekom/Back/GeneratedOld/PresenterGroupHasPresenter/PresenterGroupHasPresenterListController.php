...
namespace Controller\Ekom\Back\Generated\PresenterGroupHasPresenter;
...
class PresenterGroupHasPresenterListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_PresenterGroupHasPresenter_List";
...
select $repr from `ekev_presenter_group` where id=:presenter_group_id 
        ...
        return $this->doRenderFormList([
            ...
            'breadcrumb' => "presenter_group_has_presenter",
            'form' => "presenter_group_has_presenter",
            'list' => "presenter_group_has_presenter",
            'ric' => [
                'presenter_group_id',
                'presenter_id',
            ],
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_PresenterGroupHasPresenter_List") . "?form&presenter_group_id=$presenter_group_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_PresenterGroup_List") . "?id=$presenter_group_id",
                ],
            ],
            "context" => [
            	"presenter_group_id" => $presenter_group_id,
