...
select $repr from `ek_product_bundle` where id=:product_bundle_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_EkProductBundleHasProduct_List") . "?form&product_bundle_id=$product_bundle_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkProductBundle_List") . "?id=$product_bundle_id",
                ],
            ],
            "context" => [
            	"product_bundle_id" => $product_bundle_id,
