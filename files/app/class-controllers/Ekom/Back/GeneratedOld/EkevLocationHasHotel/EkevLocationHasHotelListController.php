...
select $repr from `ekev_location` where id=:location_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_EkevLocationHasHotel_List") . "?form&location_id=$location_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkevLocation_List") . "?id=$location_id",
                ],
            ],
            "context" => [
            	"location_id" => $location_id,
