...
namespace Controller\Ekom\Back\Generated\ProductHasFeature;
...
class ProductHasFeatureListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_ProductHasFeature_List";
...
select $repr from `ek_product` where id=:product_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_ProductHasFeature_List") . "?form&product_id=$product_id",
