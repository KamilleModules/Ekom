...
select $repr from `ektra_trainer_group` where id=:trainer_group_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_EktraTrainerGroupHasTrainer_List") . "?form&trainer_group_id=$trainer_group_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_EktraTrainerGroup_List") . "?id=$trainer_group_id",
                ],
            ],
            "context" => [
            	"trainer_group_id" => $trainer_group_id,
