...
select $repr from `di_user` where id=:user_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_DiUserHasElement_List") . "?form&user_id=$user_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_DiUser_List") . "?id=$user_id",
                ],
            ],
            "context" => [
            	"user_id" => $user_id,
