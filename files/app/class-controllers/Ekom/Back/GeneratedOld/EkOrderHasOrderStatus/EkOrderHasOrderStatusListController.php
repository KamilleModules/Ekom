...
select $repr from `ek_order` where id=:order_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_EkOrderHasOrderStatus_List") . "?form&order_id=$order_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkOrder_List") . "?id=$order_id",
                ],
            ],
            "context" => [
            	"order_id" => $order_id,
