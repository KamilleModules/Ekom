...
namespace Controller\Ekom\Back\Generated\ProductCardHasDiscount;
...
class ProductCardHasDiscountListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_ProductCardHasDiscount_List";
...
select $repr from `ek_product_card` where id=:product_card_id 
        ...
        return $this->doRenderFormList([
            ...
            'breadcrumb' => "product_card_has_discount",
            'form' => "product_card_has_discount",
            'list' => "product_card_has_discount",
            'ric' => [
                'product_card_id',
                'discount_id',
            ],
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_ProductCardHasDiscount_List") . "?form&product_card_id=$product_card_id",
