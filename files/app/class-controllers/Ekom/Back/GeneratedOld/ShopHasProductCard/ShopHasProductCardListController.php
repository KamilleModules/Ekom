...
namespace Controller\Ekom\Back\Generated\ShopHasProductCard;
...
class ShopHasProductCardListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_ShopHasProductCard_List";
...
select $repr from `ek_shop` where id=:shop_id 
        ...
        return $this->doRenderFormList([
            ...
            'breadcrumb' => "shop_has_product_card",
            'form' => "shop_has_product_card",
            'list' => "shop_has_product_card",
            'ric' => [
                'product_card_id',
            ],
            
            "newItemBtnText" => "Add a new product card for shop \"$avatar\"",
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_ShopHasProductCard_List") . "?form&shop_id=$shop_id",
