...
namespace Controller\Ekom\Back\Generated\CategoryHasProductCard;
...
class CategoryHasProductCardListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_CategoryHasProductCard_List";
...
select $repr from `ek_category` where id=:category_id 
        ...
        return $this->doRenderFormList([
            ...
            'breadcrumb' => "category_has_product_card",
            'form' => "category_has_product_card",
            'list' => "category_has_product_card",
            'ric' => [
                'category_id',
                'product_card_id',
            ],
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_CategoryHasProductCard_List") . "?form&category_id=$category_id",
