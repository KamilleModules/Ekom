...
namespace Controller\Ekom\Back\Generated\GroupHasPage;
...
class GroupHasPageListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_GroupHasPage_List";
...
select $repr from `di_group` where id=:group_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_GroupHasPage_List") . "?form&group_id=$group_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_Group_List") . "?id=$group_id",
                ],
            ],
            "context" => [
            	"group_id" => $group_id,
