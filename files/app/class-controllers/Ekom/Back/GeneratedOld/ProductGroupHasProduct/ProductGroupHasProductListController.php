...
namespace Controller\Ekom\Back\Generated\ProductGroupHasProduct;
...
class ProductGroupHasProductListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_ProductGroupHasProduct_List";
...
select $repr from `ek_product_group` where id=:product_group_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_ProductGroupHasProduct_List") . "?form&product_group_id=$product_group_id",
            ...
            "buttons" => [
                [
                    ...
                    "icon" => "fa fa-list",
                    "link" => E::link("NullosAdmin_Ekom_Generated_ProductGroup_List") . "?id=$product_group_id",
                ],
            ],
            "context" => [
            	"product_group_id" => $product_group_id,
