...
namespace Controller\Ekom\Back\Generated\UserHasProduct;
...
class UserHasProductListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_UserHasProduct_List";
...
select $repr from `ek_user` where id=:user_id 
        ...
        return $this->doRenderFormList([
            ...
            'breadcrumb' => "user_has_product",
            'form' => "user_has_product",
            'list' => "user_has_product",
            'ric' => [
                'id',
            ],
            
            "newItemBtnText" => "Add a new product for user \"$avatar\"",
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_UserHasProduct_List") . "?form&user_id=$user_id",
