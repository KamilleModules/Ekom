...
namespace Controller\Ekom\Back\Generated\UserHasUserGroup;
...
class UserHasUserGroupListController extends EkomBackSimpleFormListController
{
    public function render()
    {
        ...
        $route = "NullosAdmin_Ekom_Generated_UserHasUserGroup_List";
...
select $repr from `ek_user` where id=:user_id 
        ...
        return $this->doRenderFormList([
            ...
            "newItemBtnLink" => E::link("NullosAdmin_Ekom_Generated_UserHasUserGroup_List") . "?form&user_id=$user_id",
