...
$conf = [
    ...
    // FORM WIDGET
    //--------------------------------------------
    'title' => "Shop has product card lang",
    //--------------------------------------------
    // SOKO FORM
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($isUpdate, $product_card_id, $lang_id) {
        ...
        if (false === $isUpdate) {
            QuickPdo::insert("ek_shop_has_product_card_lang", [
            ...
            $form->addNotification("Le/la Shop has product card lang a bien été ajouté(e)", "success");
        } else {
            ...
            $form->addNotification("Le/la Shop has product card lang a bien été mis(e) à jour", "success");
        }
        return false;
    },
    //--------------------------------------------
