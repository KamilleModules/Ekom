...
$conf = [
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($isUpdate, $id) {
        ...
        if (false === $isUpdate) {
            QuickPdo::insert("ektra_trainer_group", [
				"name" => $fData["name"],
    ...
    'formAfterElements' => [
        [
            ...
            "links" => [
                ...
                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EktraTrainerGroupHasTrainer_List") . "?trainer_group_id=$id",
                    "text" => "Voir les trainers de ce/cette Trainer group",
                    "disabled" => !$isUpdate,
                ],
