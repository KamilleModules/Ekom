...
$form = SokoForm::create()
    ...
    ->setName("soko-form-shop_user_group");
...
";
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($shopIdValue, $isUpdate, $idValue) {
        ...
        if (true === $isUpdate) { // update
            ...
            $form->addNotification("Le groupe d'utilisateur a bien été mis à jour", "success");
        } else {
            ...
            try {
                ...
                $form->addNotification("Le Le groupe d'utilisateur a bien été ajouté", "success");
