...
$conf = [
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($isUpdate, $ric, $shop_id, $product_id) {
            
        if (false === $isUpdate) {
            $ric = QuickPdo::insert("ek_shop_has_product", [
    ...
    'formAfterElements' => [
        [
            ...
            "links" => [
                ...
                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkShopHasProductHasProvider_List") . "?s&shop_id=$shop_id&product_id=$product_id",
                    "text" => "Voir les shop-product-providers",
                    "disabled" => !$isUpdate,
                ],

                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkShopHasProductHasTag_List") . "?s&shop_id=$shop_id&product_id=$product_id",
                    "text" => "Voir les shop-product-tags",
                    "disabled" => !$isUpdate,
                ],

                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkShopHasProductLang_List") . "?s&shop_id=$shop_id&product_id=$product_id",
