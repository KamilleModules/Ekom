...
$conf = [
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($isUpdate, $ric, $id) {
        ...
        if (false === $isUpdate) {
            $ric = QuickPdo::insert("ekev_presenter_group", [
    ...
    'formAfterElements' => [
        [
            ...
            "links" => [
                ...
                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkevEventHasCourse_List") . "?s&presenter_group_id=$id",
                    "text" => "Voir les event-courses",
                    "disabled" => !$isUpdate,
                ],

                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkevPresenterGroupHasPresenter_List") . "?s&presenter_group_id=$id",
