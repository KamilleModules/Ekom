    ...
    'formAfterElements' => [
        [
            ...
            "links" => [
                ...
                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkInvoice_List") . "?s&seller_id=$id",
                    "text" => "Voir les invoices",
                    "disabled" => !$isUpdate,
                ],

                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkSellerHasAddress_List") . "?s&seller_id=$id",
                    "text" => "Voir les seller-addresses",
                    "disabled" => !$isUpdate,
                ],

                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkShopHasProduct_List") . "?s&seller_id=$id",
