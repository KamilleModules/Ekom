...
$conf = [
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($isUpdate, $ric, $id) {
        ...
        if (false === $isUpdate) {
            $ric = QuickPdo::insert("ekev_course", [
    ...
    'formAfterElements' => [
        [
            ...
            "links" => [
                ...
                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkevCourseLang_List") . "?s&course_id=$id",
                    "text" => "Voir les course langs",
                    "disabled" => !$isUpdate,
                ],

                [
                    "link" => E::link("NullosAdmin_Ekom_Generated_EkevEventHasCourse_List") . "?s&course_id=$id",
