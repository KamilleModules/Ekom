...
$conf = [
    ...
    'process' => function ($fData, SokoFormInterface $form) use ($isUpdate, $ric, $shop_id, $lang_id) {
            
        if (false === $isUpdate) {
            $ric = QuickPdo::insert("ek_shop_has_lang", [
				"shop_id" => $fData["shop_id"],
				"lang_id" => $fData["lang_id"],

            ], '', $ric);
            $form->addNotification("Le/la shop-lang a bien été ajouté(e)", "success");
            ...
            $form->addNotification("Le/la shop-lang a bien été mis(e) à jour", "success");
        }
        return false;
    },
    //--------------------------------------------
