...
class CarrierLayer
{
    ...
    /**
     * Apply shipping cost of the $carrier for the given price.
     * Details can potentially contain the following:
     *
     * - ?notHandled: array of productBoxModel item which cannot be handled by this carrier
     *
     *
     * @param $price
     * @param array $items , array of productBoxModel
     * @param null $carrier
     * @param array $details
     * @return mixed
     */
    public static function applyShippingCost($price, array $items, $carrier = null, array &$details = [])
    {
        if (null === $carrier) {
            $carrier = self::getCurrentCarrier();


            $userAddress = UserAddressLayer::getCurrentShippingAddress();

            if (false === $userAddress) {
                // throw an exception, this is a must have
            }
 ...
 */
public
static function getCarriers($shopId = null)
{
 ...
 */
public
static function getCurrentCarrier()
{
...
public
static function getDefaultCarrier($shopId = null)
{
...
public
function getDefaultCarrierName()
{
 ...
 */
public
function getCarrierIdByName($name)
{
 ...
 */
public
function getCarrierByName($name, $shopId = null)
{
    if (null === $shopId) {
        EkomApi::inst()->initWebContext();
        $shopId = ApplicationRegistry::get("ekom.shop_id");
 ...
 */
public
function estimateShippingCosts(array $productInfos)
{
    /**
 ...
 */
public
function calculateShippingCostByCarrierName($carrierName, array $productInfos, array $shippingAddress, $forReal = true)
{
 ...
 */
public
function getCarrierInstancesByShop($shopId)
{
    $rows = self::getCarriers($shopId);
    $ret = [];
    /**
 ...
 */
public
function getAllCarriersShippingCost(array $productInfos, array $shippingAddress)
{
...
private
function getCarrierInfoById($carrierId, $shopId)
{
    $rows = self::getCarriers($shopId);
...
private
function calculateShippingCostsByCarriers(array $carriers, array $productInfos, $shopAddress, $shippingAddress, $forReal = true)
{
    $sections = [];
    $totalShippingCost = 0;
    foreach ($carriers as $name => $carrier) {
...
private
function getCarrierNameById($id)
{
