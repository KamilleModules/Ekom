 ...
 */
class GeneratedProductCardHasProductAttribute extends TableCrudObject
{

    public function __construct()
    {
        parent::__construct();
        $this->table = "ek_product_card_has_product_attribute";
        $this->primaryKey = ['product_card_id', 'product_attribute_id'];
    }
