...
This is a major revision of 2017-11-05-database.md.
History log is now at the end of this document.
...
See the **class-modules/Ekom/doc/my/ekom-discounts.md** document.
...
In other words, I recommend not using the label overriding capabilities provided
...
- product_card_id: pk
- product_id: fk, 
            the product used as the main reference (or the representative) for the card.
...
- product_id: pk
- discount_id: pk
- conditions: see "ekom discounts conditions language" in this document
- active: 0|1
...
### Taxes
- ek_tax_group.condition has been removed
    conditions on whether or not the tax group applies are now handled in code

- ek_product_card_has_tax_group has been removed
    now a product card only has one potential tax group assigned to it

- ek_shop_has_product_card.tax_group_id has been added
    now a product card only has one potential tax group assigned to it

### Discounts
- ek_discount, the following fields have been removed:
    - user_group_id
    - currency_id
    - date_start
    - date_end
...
- ek_product_has_discount.order_phase has been removed
- ek_product_card_has_discount.order_phase has been removed
- ek_category_has_discount.order_phase has been removed

- ek_product_has_discount.conditions has been added
- ek_product_card_has_discount.conditions has been added
- ek_category_has_discount.conditions has been added

- ek_shop_has_product._sale_price_without_tax has been removed
- ek_shop_has_product._sale_price_with_tax has been removed


- ek_discount.procedure_type  has been renamed to type
