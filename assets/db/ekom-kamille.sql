...
-- -----------------------------------------------------
-- Table `kamille`.`ek_state`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_state` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `iso_code` VARCHAR(64) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_address` (
  ...
  CONSTRAINT `fk_address_state1`
    ...
    REFERENCES `kamille`.`ek_state` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_role_profile`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_role_profile` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(64) NOT NULL,
  ...
  CONSTRAINT `fk_role_profile_backoffice_user1`
    ...
    REFERENCES `kamille`.`ek_backoffice_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_role_badge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_role_badge` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_role_profile_has_role_badge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_role_profile_has_role_badge` (
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_role_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_role_group` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(64) NOT NULL,
  ...
  CONSTRAINT `fk_role_group_role_group1`
    ...
    REFERENCES `kamille`.`ek_role_group` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_role_group_has_role_badge`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_role_group_has_role_badge` (
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_role_profile_has_role_group`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_role_profile_has_role_group` (
  `role_profile_id` INT NOT NULL,
  `role_group_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_attibute_value`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_attibute_value` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(64) NOT NULL,
  `lang_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_has_product_attribute` (
  ...
  CONSTRAINT `fk_product_has_product_attribute_product_attibute_value1`
    ...
    REFERENCES `kamille`.`ek_product_attibute_value` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_video` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_has_video`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_has_video` (
  `product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_product_has_video_video1`
    ...
    REFERENCES `kamille`.`ek_video` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_reference_shop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_reference_shop` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_reference_store`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_reference_store` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_tax` (
  ...
  CONSTRAINT `fk_tax_tax_lang1`
    ...
    REFERENCES `kamille`.`ek_tax_lang` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_has_tax_rule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_has_tax_rule` (
  `product_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_category_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_category_has_product` (
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_currency_lang`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_currency_lang` (
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_condition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_condition` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(64) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_action` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_currency_shop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_currency_shop` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `currency_id` INT NOT NULL,
  `shop_id` INT NOT NULL,
  `active` TINYINT(1) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_carrier_lang`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_carrier_lang` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `label` VARCHAR(64) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_carrier_shop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_carrier_shop` (
  `carrier_id` INT NOT NULL,
  `shop_id` INT NOT NULL,
  `active` TINYINT(1) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_carrier_has_condition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_carrier_has_condition` (
  `carrier_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_carrier_has_condition_condition1`
    ...
    REFERENCES `kamille`.`ek_condition` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_carrier_has_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_carrier_has_action` (
  `carrier_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_carrier_has_action_action1`
    ...
    REFERENCES `kamille`.`ek_action` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_discount_rule`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_discount_rule` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(64) NOT NULL,
  `shop_id` INT NOT NULL,
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_discount_rule_has_condition`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_discount_rule_has_condition` (
  ...
  CONSTRAINT `fk_discount_rule_has_condition_discount_rule1`
    ...
    REFERENCES `kamille`.`ek_discount_rule` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_discount_rule_has_action`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_discount_rule_has_action` (
  `discount_rule_id` INT NOT NULL,
  `action_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_discount_rule_lang`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_discount_rule_lang` (
  `discount_rule_id` INT NOT NULL,
  `label` INT NOT NULL,
  `lang_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_reference_shop_lang`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_reference_shop_lang` (
  ...
  CONSTRAINT `fk_product_reference_shop_lang_product_reference_shop1`
    ...
    REFERENCES `kamille`.`ek_product_reference_shop` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_comment` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `shop_id` INT NOT NULL,
  `text` TEXT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_has_comment`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_has_comment` (
  `product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_product_has_comment_comment1`
    ...
    REFERENCES `kamille`.`ek_comment` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_origin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_origin` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(64) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_has_product_origin`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_has_product_origin` (
  `product_id` INT NOT NULL,
  ...
  CONSTRAINT `fk_product_has_product_origin_product_origin1`
    ...
    REFERENCES `kamille`.`ek_product_origin` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_payment_method_shop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_payment_method_shop` (
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_order_status_shop`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_order_status_shop` (
