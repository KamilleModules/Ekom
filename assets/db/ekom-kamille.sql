...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_seller` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `name_UNIQUE` (`name` ASC),
  INDEX `fk_ek_seller_ek_address1_idx` (`address_id` ASC),
  CONSTRAINT `fk_ek_seller_ek_address1`
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product` (
  ...
  INDEX `fk_ek_product_ek_provider1_idx` (`provider_id` ASC),
  ...
  CONSTRAINT `fk_ek_product_ek_manufacturer1`
    ...
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_product_ek_provider1`
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_gender` (
  ...
  `name` VARCHAR(64) NOT NULL,
  `label` VARCHAR(64) NOT NULL,
  `long_label` VARCHAR(64) NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_user` (
  ...
  `newsletter_registration_date` DATETIME NULL,
  `newsletter_registration_ip` VARCHAR(16) NOT NULL,
  `birthday` DATE NULL,
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_discount` (
  ...
  `apply_product_reference_ids` TEXT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_order` (
  ...
  `cart_total_tax_excluded` DECIMAL(20,2) NOT NULL,
  `shipping_cost_tax_excluded` DECIMAL(20,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_coupon` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE INDEX `code_UNIQUE` (`code` ASC),
  INDEX `fk_ek_coupon_ek_seller1_idx` (`seller_id` ASC),
  CONSTRAINT `fk_ek_coupon_ek_seller1`
    FOREIGN KEY (`seller_id`)
    REFERENCES `kamille`.`ek_seller` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_newsletter` (
  ...
  `active` TINYINT(1) NOT NULL,
  `ip_registration` VARCHAR(16) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE INDEX `email_UNIQUE` (`email` ASC))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_reference`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_reference` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `product_id` INT NOT NULL,
  `date_added` DATETIME NOT NULL,
  `reference` VARCHAR(64) NOT NULL,
  `price` DECIMAL(20,2) NOT NULL,
  `quantity` INT NOT NULL,
  `_product_details` VARCHAR(256) NOT NULL,
  `extra1` VARCHAR(64) NOT NULL,
  `extra2` VARCHAR(64) NOT NULL,
  `is_orderable_when_out_of_stock` TINYINT(1) NOT NULL,
  `out_of_stock_text` VARCHAR(128) NOT NULL,
  `active` TINYINT(1) NOT NULL,
  `is_available` TINYINT(1) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ek_product_reference_ek_product1_idx` (`product_id` ASC),
  INDEX `my_reference_index` (`reference` ASC),
  CONSTRAINT `fk_ek_product_reference_ek_product1`
    FOREIGN KEY (`product_id`)
    REFERENCES `kamille`.`ek_product` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_variation` (
  ...
  `cond_identifier` VARCHAR(64) NULL,
  `price` DECIMAL(20,2) NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ek_product_variation_ek_product_reference1_idx` (`product_reference_id` ASC),
  CONSTRAINT `fk_ek_product_variation_ek_product_reference1`
    FOREIGN KEY (`product_reference_id`)
    REFERENCES `kamille`.`ek_product_reference` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_reference_has_discount`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_reference_has_discount` (
  `product_reference_id` INT NOT NULL,
  `discount_id` INT NOT NULL,
  PRIMARY KEY (`product_reference_id`, `discount_id`),
  INDEX `fk_ek_product_reference_has_ek_discount_ek_discount1_idx` (`discount_id` ASC),
  INDEX `fk_ek_product_reference_has_ek_discount_ek_product_referenc_idx` (`product_reference_id` ASC),
  CONSTRAINT `fk_ek_product_reference_has_ek_discount_ek_product_reference1`
    FOREIGN KEY (`product_reference_id`)
    REFERENCES `kamille`.`ek_product_reference` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_product_reference_has_ek_discount_ek_discount1`
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_user_has_product_reference`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_user_has_product_reference` (
  `user_id` INT NOT NULL,
  `product_reference_id` INT NOT NULL,
  `date_added` DATETIME NOT NULL,
  `date_deleted` DATETIME NOT NULL,
  PRIMARY KEY (`user_id`, `product_reference_id`),
  INDEX `fk_ek_user_has_ek_product_reference_ek_product_reference1_idx` (`product_reference_id` ASC),
  INDEX `fk_ek_user_has_ek_product_reference_ek_user1_idx` (`user_id` ASC),
  CONSTRAINT `fk_ek_user_has_ek_product_reference_ek_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `kamille`.`ek_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_user_has_ek_product_reference_ek_product_reference1`
    FOREIGN KEY (`product_reference_id`)
    REFERENCES `kamille`.`ek_product_reference` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_user_visited_product_reference`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_user_visited_product_reference` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `product_reference_id` INT NOT NULL,
  `date` DATETIME NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ek_user_visited_product_reference_ek_user1_idx` (`user_id` ASC),
  INDEX `fk_ek_user_visited_product_reference_ek_product_reference1_idx` (`product_reference_id` ASC),
  CONSTRAINT `fk_ek_user_visited_product_reference_ek_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `kamille`.`ek_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_user_visited_product_reference_ek_product_reference1`
    FOREIGN KEY (`product_reference_id`)
    REFERENCES `kamille`.`ek_product_reference` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_user_has_coupon`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_user_has_coupon` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `user_id` INT NOT NULL,
  `coupon_id` INT NOT NULL,
  `date_added` DATETIME NOT NULL,
  INDEX `fk_ek_user_has_ek_coupon_ek_coupon1_idx` (`coupon_id` ASC),
  INDEX `fk_ek_user_has_ek_coupon_ek_user1_idx` (`user_id` ASC),
  PRIMARY KEY (`id`),
  CONSTRAINT `fk_ek_user_has_ek_coupon_ek_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `kamille`.`ek_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_user_has_ek_coupon_ek_coupon1`
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_shop` (
  `label` VARCHAR(64) NOT NULL,
  `address_id` INT NOT NULL,
  INDEX `fk_ek_shop_ek_address1_idx` (`address_id` ASC),
  CONSTRAINT `fk_ek_shop_ek_address1`
    FOREIGN KEY (`address_id`)
    REFERENCES `kamille`.`ek_address` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_page`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_page` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_purchase_stat_category`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_purchase_stat_category` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `product_purchase_stat_id` INT NOT NULL,
  `category_id` INT NOT NULL,
  PRIMARY KEY (`id`))
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_order_purchase_stat_coupon`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_order_purchase_stat_coupon` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `order_id` INT NOT NULL,
  `label` VARCHAR(256) NOT NULL,
  `code` VARCHAR(64) NOT NULL,
  `seller_label` VARCHAR(128) NOT NULL,
  `action_type` VARCHAR(1) NOT NULL,
  `action_value` DECIMAL(20,2) NOT NULL,
  `saving` DECIMAL(20,2) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_order_purchase_stat_provider`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_order_purchase_stat_provider` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `order_id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_order_purchase_stat_seller`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_order_purchase_stat_seller` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `order_id` INT NOT NULL,
  `seller_label` VARCHAR(128) NOT NULL,
  `amount` DECIMAL(20,2) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_page_not_found`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_page_not_found` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_search_stat`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_search_stat` (
  `id` INT NOT NULL AUTO_INCREMENT,
