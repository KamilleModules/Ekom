...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_shop_has_product` (
  ...
  `active` TINYINT(1) NOT NULL,
  `_sale_price_without_tax` DECIMAL(20,2) NOT NULL,
  `_sale_price_with_tax` DECIMAL(20,2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_shop_has_product_card_lang` (
  ...
  UNIQUE INDEX `slug_UNIQUE` (`slug` ASC, `shop_id` ASC, `lang_id` ASC),
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_order` (
  ...
  `pay_identifier` VARCHAR(64) NOT NULL,
