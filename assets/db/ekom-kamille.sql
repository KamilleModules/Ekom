...
-- -----------------------------------------------------
-- Table `kamille`.`ek_user_has_payment_method`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_user_has_payment_method` (
  `user_id` INT NOT NULL,
  `shop_id` INT NOT NULL,
  `payment_method_id` INT NOT NULL,
  `options` TEXT NOT NULL,
  `order` INT NOT NULL,
  PRIMARY KEY (`user_id`, `shop_id`, `payment_method_id`),
  INDEX `fk_ek_user_has_ek_shop_ek_shop1_idx` (`shop_id` ASC),
  INDEX `fk_ek_user_has_ek_shop_ek_user1_idx` (`user_id` ASC),
  INDEX `fk_ek_user_has_ek_shop_ek_payment_method1_idx` (`payment_method_id` ASC),
  CONSTRAINT `fk_ek_user_has_ek_shop_ek_user1`
    FOREIGN KEY (`user_id`)
    REFERENCES `kamille`.`ek_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_user_has_ek_shop_ek_shop1`
    FOREIGN KEY (`shop_id`)
    REFERENCES `kamille`.`ek_shop` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_user_has_ek_shop_ek_payment_method1`
    FOREIGN KEY (`payment_method_id`)
    REFERENCES `kamille`.`ek_payment_method` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
