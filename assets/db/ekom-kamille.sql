...
-- -----------------------------------------------------
-- Table `kamille`.`ek_multiproduct`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_multiproduct` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_multiproduct_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_multiproduct_has_product` (
  `multiproduct_id` INT NOT NULL,
  `product_id` INT NOT NULL,
  `quantity` INT NOT NULL,
  `active` TINYINT(1) NOT NULL,
  PRIMARY KEY (`multiproduct_id`, `product_id`),
  INDEX `fk_ek_multiproduct_has_ek_product_ek_product1_idx` (`product_id` ASC),
  INDEX `fk_ek_multiproduct_has_ek_product_ek_multiproduct1_idx` (`multiproduct_id` ASC),
  CONSTRAINT `fk_ek_multiproduct_has_ek_product_ek_multiproduct1`
    FOREIGN KEY (`multiproduct_id`)
    REFERENCES `kamille`.`ek_multiproduct` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
