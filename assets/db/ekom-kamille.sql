...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_shop_has_product` (
  ...
  `active` TINYINT(1) NOT NULL,
  `_sale_price_without_tax` DECIMAL(20,6) NOT NULL,
  `_sale_price_with_tax` DECIMAL(20,6) NOT NULL,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_user_has_ek_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_user_has_ek_product` (
  `ek_user_id` INT NOT NULL,
  `ek_product_id` INT NOT NULL,
  PRIMARY KEY (`ek_user_id`, `ek_product_id`),
  INDEX `fk_ek_user_has_ek_product_ek_product1_idx` (`ek_product_id` ASC),
  INDEX `fk_ek_user_has_ek_product_ek_user1_idx` (`ek_user_id` ASC),
  CONSTRAINT `fk_ek_user_has_ek_product_ek_user1`
    FOREIGN KEY (`ek_user_id`)
    REFERENCES `kamille`.`ek_user` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_user_has_ek_product_ek_product1`
    FOREIGN KEY (`ek_product_id`)
    REFERENCES `kamille`.`ek_product` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_combination`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_combination` (
  `id` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `kamille`.`ek_product_combination_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_product_combination_has_product` (
  `product_combination_id` INT NOT NULL,
  `product_id` INT NOT NULL,
  `quantity` INT NOT NULL,
  `active` TINYINT(1) NOT NULL,
  PRIMARY KEY (`product_combination_id`, `product_id`),
  INDEX `fk_ek_multiproduct_has_ek_product_ek_product1_idx` (`product_id` ASC),
  INDEX `fk_ek_multiproduct_has_ek_product_ek_multiproduct1_idx` (`product_combination_id` ASC),
  CONSTRAINT `fk_ek_multiproduct_has_ek_product_ek_multiproduct1`
    FOREIGN KEY (`product_combination_id`)
    REFERENCES `kamille`.`ek_product_combination` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_multiproduct_has_ek_product_ek_product1`
    FOREIGN KEY (`product_id`)
    REFERENCES `kamille`.`ek_product` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
