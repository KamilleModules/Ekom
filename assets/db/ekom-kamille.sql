...
-- -----------------------------------------------------
-- Table `kamille`.`ek_provider_has_shop_has_product`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `kamille`.`ek_provider_has_shop_has_product` (
  `provider_id` INT NOT NULL,
  `shop_has_product_shop_id` INT NOT NULL,
  `shop_has_product_product_id` INT NOT NULL,
  PRIMARY KEY (`provider_id`, `shop_has_product_shop_id`, `shop_has_product_product_id`),
  INDEX `fk_ek_provider_has_ek_shop_has_product_ek_shop_has_product1_idx` (`shop_has_product_shop_id` ASC, `shop_has_product_product_id` ASC),
  INDEX `fk_ek_provider_has_ek_shop_has_product_ek_provider1_idx` (`provider_id` ASC),
  CONSTRAINT `fk_ek_provider_has_ek_shop_has_product_ek_provider1`
    FOREIGN KEY (`provider_id`)
    REFERENCES `kamille`.`ek_provider` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_ek_provider_has_ek_shop_has_product_ek_shop_has_product1`
    FOREIGN KEY (`shop_has_product_shop_id` , `shop_has_product_product_id`)
    REFERENCES `kamille`.`ek_shop_has_product` (`shop_id` , `product_id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_shop_has_product_has_tag` (
  ...
  `shop_has_product_product_id` INT NOT NULL,
  `tag_id` INT NOT NULL,
  PRIMARY KEY (`shop_has_product_shop_id`, `shop_has_product_product_id`, `tag_id`),
  INDEX `fk_ek_shop_has_product_has_ek_tag_ek_tag1_idx` (`tag_id` ASC),
  INDEX `fk_ek_shop_has_product_has_ek_tag_ek_shop_has_product1_idx` (`shop_has_product_shop_id` ASC, `shop_has_product_product_id` ASC),
