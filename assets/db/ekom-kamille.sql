...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_backoffice_user` (
  ...
  `lang_id` INT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_backoffice_user_lang1_idx` (`lang_id` ASC),
  UNIQUE INDEX `email_UNIQUE` (`email` ASC),
  CONSTRAINT `fk_backoffice_user_lang1`
  FOREIGN KEY (`lang_id`)
...
CREATE TABLE IF NOT EXISTS `kamille`.`ek_shop_has_product_lang` (
  ...
  `lang_id` INT NOT NULL,
  PRIMARY KEY (`id`),
  INDEX `fk_ek_shop_has_product_lang_ek_shop_has_product1_idx` (`shop_has_product_shop_id` ASC, `shop_has_product_product_id` ASC),
